...
export const products: Product[] = [
  {
    ...
    categoryId: 'burgers',
    name: { ar: 'كوبد برقر', en: 'COPID Burger' },
    description: {
  ...
  },
  {
    ...
    description: {
      ar: '٦ قطع أجنحة دجاج - صوص سبايسي شيبوتلي - شيبوتلي رانش - صوص سبايسي سموكي',
      en: '6 chicken wings - Spicy chipotle sauce - Chipotle ranch - Spicy smoky sauce',
    },
  ...
  },
  {
    ...
    description: {
      ar: 'بطاطس ذهبية مقرمشة - صوص C - لحم سموكي - صوص سبايسي سموكي',
      en: 'Golden crispy fries - C Sauce - Smoky beef - Spicy smoky sauce',
    },
  ...
  },
  {
    ...
    description: {
      ar: 'بطاطس مقلية مغطاة بدجاج كرسبي، صوص C، صوص باربكيو، وبصل أخضر. - صوص بافلو سويت - صوص رانش - مبشور بطاطا - مبشور بنجر',
      en: 'Crispy fries topped with crispy chicken, signature C Sauce, BBQ sauce, and fresh chives. - Sweet buffalo sauce - Ranch sauce - Shredded potato - Shredded beet',
    },
  ...
  },
  {
    ...
    image: '/images/products/copid_french_fries.png',
    calories: 344,
    price: 5,
    available: true,
  },
  {
    ...
    description: {
      ar: 'جبنة بارميزان - يقدم مع صوص شيبوتلي رانش',
      en: 'جبنة بارميزان - يقدم مع صوص شيبوتلي رانش',
    },
